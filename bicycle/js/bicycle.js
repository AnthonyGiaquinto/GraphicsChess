...
var Bicycle = function( loader ) {
    ...
    loader.load( 'bicycle/models/frame.obj', 'bicycle/materials/frame.mtl', function ( frame ) {
        frame.position.x = 0;

        loader.load( 'bicycle/models/handle.obj', 'bicycle/materials/chrome.mtl', function ( handlebar ) {

            self.handlebar = handlebar;

            loader.load( 'bicycle/models/fork.obj', 'bicycle/materials/paint.mtl', function ( fork ) {
                ...
                loader.load( 'bicycle/models/grip.obj', 'bicycle/materials/rubber.mtl', function ( object ) {
                    ...
                    loader.load( 'bicycle/models/rim.obj', 'bicycle/materials/chrome.mtl', function ( rim ) {

                        var rearRim = cloneObjMtl(rim);
                        self.frontWheel.add( rim );
                        self.rearWheel.add( rearRim );

                        loader.load( 'bicycle/models/tire.obj', 'bicycle/materials/rubber.mtl', function ( tire ) {
